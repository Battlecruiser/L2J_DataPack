...
class Quest (JQuest) :
 ...
 def onKill(self,npc,player,isPet):
   ...
   npcId = npc.getNpcId()
   if npcId != 20782 :
        if st.getInt("cond")==1 and st.getQuestItemsCount(TOPAZ_PIECE)<20 and getRandom(100)<70 :
        ...
        if st.getInt("cond")==4 and st.getQuestItemsCount(EMERALD_PIECE)<20 and getRandom(100)<50 :

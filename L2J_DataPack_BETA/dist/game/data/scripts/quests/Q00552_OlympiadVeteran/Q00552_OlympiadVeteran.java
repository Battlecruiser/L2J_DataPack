			...
			if ((st != null) && st.isStarted())
			{
				...
				switch (type)
				{
					case CLASSED:
					{
						...
						if (matches == 5)
						{
							giveItems(loser, CLASS_BATTLE_CERTIFICATE, 1);
						}
						break;
					}
					case NON_CLASSED:
					{
						...
						if (matches == 5)
						{
							giveItems(loser, CLASS_FREE_BATTLE_CERTIFICATE, 1);
						}
						break;
					}
					case TEAMS:
					{
						...
						if (matches == 5)
						{
							giveItems(loser, TEAM_EVENT_CERTIFICATE, 1);
						}
						break;
					}
				}
			...
			if ((st != null) && st.isStarted())
			{
				...
				switch (type)
				{
					case CLASSED:
					{
						...
						{
							giveItems(winner, CLASS_BATTLE_CERTIFICATE, 1);
						}
						break;
					}
					case NON_CLASSED:
					{
						...
						{
							giveItems(winner, CLASS_FREE_BATTLE_CERTIFICATE, 1);
						}
						break;
					}
					case TEAMS:
					{
						...
						{
							giveItems(winner, TEAM_EVENT_CERTIFICATE, 1);
						}
						break;
					}
				}

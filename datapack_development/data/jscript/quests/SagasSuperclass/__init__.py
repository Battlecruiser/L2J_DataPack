 ...
 def giveHallishaMark(self, st2) :
     if st2.getInt("spawned") == 0 :
        if st2.getQuestItemsCount(self.Items[3]) >= 700:
            ...
            st2.set("spawned","1")
            st2.startQuestTimer("Archon Hellisha has despawned",600000,Archon,None)
 ...
 def onAdvEvent (self,event,npc, player) :
   ...
   if event == "accept" :
       ...
       if st.getInt("spawned") == 1 :
           ...
           st.set("spawned","1")
           st.startQuestTimer("Mob_1 Timer 1",500,Mob_1,None)
           st.startQuestTimer("Mob_1 has despawned",300000,Mob_1,None)
       ...
       if st.getInt("Quest0") == 0 :
           ...
           st.set("Quest0","1")
           st.set("Quest1","45")
           st.startQuestTimer("Mob_3 Timer 1",500,Mob_3,None)
           st.startQuestTimer("Mob_3 has despawned",59000,Mob_3,None)
           st.startQuestTimer("Mob_2 Timer 1",500,Mob_2,None)
           st.startQuestTimer("Mob_2 has despawned",60000,Mob_2,None)
           htmltext = "10-02.htm"
       ...
       if npc.getKnownList().knowsObject(Mob_2) :
           ...
           st.startQuestTimer("Mob_3 Timer 1",500,npc,None)
       return
       ...
       st.startQuestTimer("Mob_2 Timer 2",1500,npc,None)
       if st.getInt("Quest1") == 45 :
           st.set("Quest1","0")
       return
   elif event == "Mob_2 Timer 2" :
       self.AutoChat(npc,self.Text[8].replace('PLAYERNAME',player.getName()))
       st.startQuestTimer("Mob_2 Timer 3",10000,npc,None)
       return
   elif event == "Mob_2 Timer 3" :
       if st.getInt("Quest0") == 0 :
           st.startQuestTimer("Mob_2 Timer 3",13000,npc,None)
           if st.getRandom(2) == 0 :
       ...
       if st.getInt("Quest0") == 1 or st.getInt("Quest0") == 2 or st.getInt("Quest1") > 3 :
           ...
           st.startQuestTimer("Mob_2 has despawned",1000,npc,None)
       return
   return htmltext

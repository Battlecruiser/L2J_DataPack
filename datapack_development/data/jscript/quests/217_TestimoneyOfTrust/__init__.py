...
class Quest (JQuest) :
 ...
 def onTalk (Self,npcId,st):
   ...
   if npcId == 7191 and int(st.get("cond"))==0 and int(st.get("onlyone"))==0 :
   ...
   elif npcId == 7191 and int(st.get("cond"))==1 and GetMemoState==7 and st.getQuestItemsCount(SCROLL_OF_ELF_TRUST_ID) and st.getQuestItemsCount(SCROLL_OF_DARKELF_TRUST_ID) :
      ...
      st.set("cond","8")
   elif npcId == 7191 and int(st.get("cond"))==1 and GetMemoState==18 and st.getQuestItemsCount(SCROLL_OF_DWARF_TRUST_ID) and st.getQuestItemsCount(SCROLL_OF_ORC_TRUST_ID) :
      ...
      st.set("cond","19")
   elif npcId == 7191 and int(st.get("cond"))==1 and GetMemoState==19 :
      htmltext = "7191-07.htm"
   elif npcId == 7191 and int(st.get("cond"))==1 and GetMemoState==1 :
      htmltext = "7191-08.htm"
   elif npcId == 7191 and int(st.get("cond"))==1 and GetMemoState==8 :
      htmltext = "7191-09.htm"
   elif npcId == 7154 and int(st.get("cond"))==1 and GetMemoState==1 and st.getQuestItemsCount(LETTER_TO_ELF_ID) :
      htmltext = "7154-01.htm"
   elif npcId == 7154 and int(st.get("cond"))==1 and GetMemoState==2 and st.getQuestItemsCount(ORDER_OF_OZZY_ID) :
      htmltext = "7154-04.htm"
   elif npcId == 7154 and int(st.get("cond"))==1 and GetMemoState==3 and st.getQuestItemsCount(BREATH_OF_WINDS_ID) and st.getQuestItemsCount(SEED_OF_VERDURE_ID) :
      ...
      st.set("cond","4")
   elif npcId == 7154 and int(st.get("cond"))==1 and GetMemoState==4 :
      htmltext = "7154-06.htm"
   elif npcId == 7358 and int(st.get("cond"))==1 and GetMemoState==4 and st.getQuestItemsCount(LETTER_TO_DARKELF_ID) :
      htmltext = "7358-01.htm"
   elif npcId == 7358 and int(st.get("cond"))==1 and GetMemoState==6 and st.getQuestItemsCount(ORDER_OF_CLAYTON_ID) and ((st.getQuestItemsCount(STAKATO_ICHOR_ID)+st.getQuestItemsCount(HONEY_DEW_ID)+st.getQuestItemsCount(BASILISK_PLASMA_ID))==3) :
      ...
      st.set("cond","7")
   elif npcId == 7358 and int(st.get("cond"))==1 and GetMemoState==7 :
      htmltext = "7358-04.htm"
   elif npcId == 7358 and int(st.get("cond"))==1 and GetMemoState==5 :
      htmltext = "7358-05.htm"
   elif npcId == 7464 and int(st.get("cond"))==1 and GetMemoState==5 and st.getQuestItemsCount(LETTER_OF_THIFIELL_ID) :
      htmltext = "7464-01.htm"
      st.giveItems(ORDER_OF_CLAYTON_ID,1)
      st.takeItems(LETTER_OF_THIFIELL_ID,1)
      st.set("cond","6")
   elif npcId == 7464 and int(st.get("cond"))==1 and GetMemoState==6 and st.getQuestItemsCount(ORDER_OF_CLAYTON_ID) and ((st.getQuestItemsCount(STAKATO_ICHOR_ID)+st.getQuestItemsCount(HONEY_DEW_ID)+st.getQuestItemsCount(BASILISK_PLASMA_ID))<3) :
      htmltext = "7464-02.htm"
   elif npcId == 7464 and int(st.get("cond"))==1 and GetMemoState==6 and st.getQuestItemsCount(ORDER_OF_CLAYTON_ID) and ((st.getQuestItemsCount(STAKATO_ICHOR_ID)+st.getQuestItemsCount(HONEY_DEW_ID)+st.getQuestItemsCount(BASILISK_PLASMA_ID))==3) :
      htmltext = "7464-03.htm"
   elif npcId == 7657 and int(st.get("cond"))==1 and GetMemoState==8 and st.getQuestItemsCount(LETTER_TO_SERESIN_ID) :
      htmltext = "7657-01.htm"
   elif npcId == 7657 and int(st.get("cond"))==1 and GetMemoState==9 :
      htmltext = "7657-04.htm"
   elif npcId == 7657 and int(st.get("cond"))==1 and GetMemoState==18 :
      htmltext = "7657-05.htm"
   elif npcId == 7565 and int(st.get("cond"))==1 and GetMemoState==9 and st.getQuestItemsCount(LETTER_TO_ORC_ID) :
      htmltext = "7565-01.htm"
   elif npcId == 7565 and int(st.get("cond"))==1 and GetMemoState==10 :
      htmltext = "7565-03.htm"
   elif npcId == 7565 and int(st.get("cond"))==1 and GetMemoState==13 :
      htmltext = "7565-04.htm"
      st.giveItems(SCROLL_OF_ORC_TRUST_ID,1)
      st.takeItems(LETTER_OF_MANAKIA_ID,1)
      st.set("cond","14")
   elif npcId == 7565 and int(st.get("cond"))==1 and GetMemoState==14 :
   ...
   elif npcId == 7515 and int(st.get("cond"))==1 and GetMemoState==11 :
      htmltext = "7515-03.htm"
   elif npcId == 7515 and int(st.get("cond"))==1 and GetMemoState==12 and st.getQuestItemsCount(PARASITE_OF_LOTA_ID)==10 :
      ...
      st.set("cond","13")
   elif npcId == 7515 and int(st.get("cond"))==1 and GetMemoState==13 :
      htmltext = "7515-05.htm"
   elif npcId == 7531 and int(st.get("cond"))==1 and GetMemoState==14 and st.getQuestItemsCount(LETTER_TO_DWARF_ID) :
      htmltext = "7531-01.htm"
   elif npcId == 7531 and int(st.get("cond"))==1 and GetMemoState==15 :
      htmltext = "7531-03.htm"
   elif npcId == 7531 and int(st.get("cond"))==1 and GetMemoState==17 :
      htmltext = "7531-04.htm"
      st.giveItems(SCROLL_OF_DWARF_TRUST_ID,1)
      st.set("cond","18")
   elif npcId == 7531 and int(st.get("cond"))==1 and GetMemoState==18 :
      htmltext = "7531-05.htm"
   elif npcId == 7621 and int(st.get("cond"))==1 and GetMemoState==15 and st.getQuestItemsCount(LETTER_TO_NICHOLA_ID) :
      htmltext = "7621-01.htm"
   elif npcId == 7621 and int(st.get("cond"))==1 and GetMemoState==16 and st.getQuestItemsCount(HEART_OF_PORTA_ID)<10 :
      ...
      st.set("cond","17")
   elif npcId == 7621 and int(st.get("cond"))==1 and GetMemoState==17 :
      htmltext = "7621-05.htm"
   elif npcId == 7031 and int(st.get("cond"))==1 and GetMemoState==19 and st.getQuestItemsCount(RECOMMENDATION_OF_HOLLIN_ID) :

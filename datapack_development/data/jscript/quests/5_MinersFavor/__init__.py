...
class Quest (JQuest) :
 ...
 def onTalk (self,npc,st):
   ...
   id    = st.getState()
   cond  = st.getInt("cond")
   count_BL = st.getQuestItemsCount(BOLTERS_LIST)
   ...
   elif npcId == SHARI and cond == 1 and count_BL :
   ...
   elif npcId == GARITA and cond == 1 and count_BL :
   ...
   elif npcId == REED and cond == 1 and count_BL :
   ...
   elif npcId == BRUNON and cond == 1 and count_BL :
...
COMPLETED.addTalkId(BOLTER)

for i in range(1547,1552) :
   STARTED.addQuestDrop(BOLTER,i,1)

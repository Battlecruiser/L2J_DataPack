     ...
     if npcId == ABYSS_JEWEL1 :
         if cond == 2 and st.getInt("moke")<>1:
             if nowHp < maxHp*0.8 and st.getInt("aspawned")<>1 :
                 ...
                 st.set("aspawned","1")
                 st.startQuestTimer("Jewel1_Timer1",900000,npc,None)
                 ...
                 st.startQuestTimer("Jewel1_Timer2",240000,npc,None)
         if nowHp < maxHp*0.1 :
             npc.decayMe()
             st.getQuestTimer("Jewel1_Timer1").cancel()
             st.getQuestTimer("Jewel1_Timer2").cancel()
     if npcId == ABYSS_JEWEL2 :
         if cond == 2 and st.getInt("helton")<>1:
             if nowHp < maxHp*0.8 and st.getInt("bspawned")<>1 :
                 ...
                 st.set("bspawned","1")
                 st.startQuestTimer("Jewel2_Timer1",900000,npc,None)
                 ...
                 st.playSound("ItemSound.quest_itemget")
                 st.startQuestTimer("Jewel2_Timer2",240000,npc,None)
         if nowHp < maxHp*0.1 :
             npc.decayMe()
             st.getQuestTimer("Jewel2_Timer1").cancel()
             st.getQuestTimer("Jewel2_Timer2").cancel()

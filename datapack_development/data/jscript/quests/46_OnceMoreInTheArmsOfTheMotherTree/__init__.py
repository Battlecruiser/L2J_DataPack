 ...
 def onTalk (self,npc,st):
   ...
   if id == CREATED :
     if st.getPlayer().getLevel() >= 3 :
       if st.getPlayer().getRace().ordinal() == 1 and st.getQuestItemsCount(MARK_OF_TRAVELER) > 0 :
...
qnum  = 46
qdef  = str(qnum) + "_OnceMoreInTheArmsOfTheMotherTree"
qname = "Once More In the Arms of the Mother Tree"

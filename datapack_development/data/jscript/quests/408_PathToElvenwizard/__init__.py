...
class Quest (JQuest) :
 ...
 def onEvent (self,event,st) :
    ...
    if event == "1" :
        ...
        if st.getPlayer().getClassId().getId() != 0x19 :
          ...
          if int(st.get("cond")) != 0 and st.getQuestItemsCount(MAGICAL_POWERS_RUBY) != 0 :
            htmltext = "30414-10.htm"
          elif int(st.get("cond")) != 0 and st.getQuestItemsCount(MAGICAL_POWERS_RUBY) == 0 and st.getQuestItemsCount(FERTILITY_PERIDOT) != 0 :
            if st.getQuestItemsCount(ROGELLIAS_LETTER) == 0 :
              st.giveItems(ROGELLIAS_LETTER,1)
            htmltext = "30414-07.htm"
            st.set("cond","2")
    elif event == "408_4" :
          if int(st.get("cond")) != 0 and st.getQuestItemsCount(ROGELLIAS_LETTER) != 0 :
          ...
          if int(st.get("cond")) != 0 and st.getQuestItemsCount(PURE_AQUAMARINE) != 0 :
            htmltext = "30414-13.htm"
          elif int(st.get("cond")) != 0 and st.getQuestItemsCount(PURE_AQUAMARINE) == 0 and st.getQuestItemsCount(FERTILITY_PERIDOT) != 0 :
            if st.getQuestItemsCount(APPETIZING_APPLE) == 0 :
              st.giveItems(APPETIZING_APPLE,1)
            htmltext = "30414-14.htm"
    elif event == "408_5" :
          if int(st.get("cond")) != 0 and st.getQuestItemsCount(APPETIZING_APPLE) != 0 :
          ...
          if int(st.get("cond")) != 0 and st.getQuestItemsCount(NOBILITY_AMETHYST) != 0 :
            htmltext = "30414-17.htm"
          elif int(st.get("cond")) != 0 and st.getQuestItemsCount(NOBILITY_AMETHYST) == 0 and st.getQuestItemsCount(FERTILITY_PERIDOT) != 0 :
 ...
 def onTalk (self,npc,player):
   ...
   if npcId == 30414 and int(st.get("cond"))==0 :
        if int(st.get("cond"))<15 :
          ...
          htmltext = "30414-01.htm"
   elif npcId == 30414 and int(st.get("cond"))!=0 and st.getQuestItemsCount(ROGELLIAS_LETTER)==0 and st.getQuestItemsCount(APPETIZING_APPLE)==0 and st.getQuestItemsCount(IMMORTAL_LOVE)==0 and st.getQuestItemsCount(CHARM_OF_GRAIN)==0 and st.getQuestItemsCount(SAP_OF_WORLD_TREE)==0 and st.getQuestItemsCount(LUCKY_POTPOURI)==0 and st.getQuestItemsCount(FERTILITY_PERIDOT)!=0 and (st.getQuestItemsCount(MAGICAL_POWERS_RUBY)==0 or st.getQuestItemsCount(NOBILITY_AMETHYST)==0 or st.getQuestItemsCount(PURE_AQUAMARINE)==0) :
        htmltext = "30414-11.htm"
   elif npcId == 30414 and int(st.get("cond"))!=0 and st.getQuestItemsCount(ROGELLIAS_LETTER)!=0 :
        htmltext = "30414-08.htm"
   elif npcId == 30157 and int(st.get("cond"))!=0 and st.getQuestItemsCount(ROGELLIAS_LETTER)!=0 :
        htmltext = "30157-01.htm"
   elif npcId == 30157 and int(st.get("cond"))!=0 and st.getQuestItemsCount(CHARM_OF_GRAIN)!=0 and st.getQuestItemsCount(RED_DOWN)<5 :
   ...
   elif npcId == 30414 and int(st.get("cond"))!=0 and st.getQuestItemsCount(CHARM_OF_GRAIN)!=0 and st.getQuestItemsCount(RED_DOWN)<5 :
        htmltext = "30414-09.htm"
   elif npcId == 30414 and int(st.get("cond"))!=0 and st.getQuestItemsCount(CHARM_OF_GRAIN)!=0 and st.getQuestItemsCount(RED_DOWN)>=5 :
        htmltext = "30414-25.htm"
   elif npcId == 30414 and int(st.get("cond"))!=0 and st.getQuestItemsCount(APPETIZING_APPLE)!=0 :
        htmltext = "30414-15.htm"
   elif npcId == 30371 and int(st.get("cond"))!=0 and st.getQuestItemsCount(APPETIZING_APPLE)!=0 :
        htmltext = "30371-01.htm"
   elif npcId == 30371 and int(st.get("cond"))!=0 and st.getQuestItemsCount(SAP_OF_WORLD_TREE)!=0 and st.getQuestItemsCount(GOLD_LEAVES)<5 :
   ...
   elif npcId == 30414 and int(st.get("cond"))!=0 and st.getQuestItemsCount(SAP_OF_WORLD_TREE)!=0 and st.getQuestItemsCount(GOLD_LEAVES)<5 :
        htmltext = "30414-16.htm"
   elif npcId == 30414 and int(st.get("cond"))!=0 and st.getQuestItemsCount(CHARM_OF_GRAIN)!=0 and st.getQuestItemsCount(GOLD_LEAVES)>=5 :
        htmltext = "30414-26.htm"
   elif npcId == 30414 and int(st.get("cond"))!=0 and st.getQuestItemsCount(IMMORTAL_LOVE)!=0 :
        htmltext = "30414-19.htm"
   elif npcId == 30423 and int(st.get("cond"))!=0 and st.getQuestItemsCount(IMMORTAL_LOVE)!=0 :
   ...
   elif npcId == 30423 and int(st.get("cond"))!=0 and st.getQuestItemsCount(LUCKY_POTPOURI)!=0 and st.getQuestItemsCount(AMETHYST)<2 :
   ...
   elif npcId == 30414 and int(st.get("cond"))!=0 and st.getQuestItemsCount(LUCKY_POTPOURI)!=0 and st.getQuestItemsCount(AMETHYST)<2 :
 ...
 def onKill (self,npc,player):
   ...
   if npcId == 20466 :
        st.set("id","0")
        if int(st.get("cond")) != 0 and st.getQuestItemsCount(CHARM_OF_GRAIN) != 0 and st.getQuestItemsCount(RED_DOWN)<5 and st.getRandom(100)<70 :
        ...
        st.set("id","0")
        if int(st.get("cond")) != 0 and st.getQuestItemsCount(SAP_OF_WORLD_TREE) != 0 and st.getQuestItemsCount(GOLD_LEAVES)<5 and st.getRandom(100)<40 :
        ...
        st.set("id","0")
        if int(st.get("cond")) != 0 and st.getQuestItemsCount(LUCKY_POTPOURI) != 0 and st.getQuestItemsCount(AMETHYST)<2 and st.getRandom(100)<40 :

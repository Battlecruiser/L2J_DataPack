...
class Quest (JQuest) :
 ...
 def onTalk (Self,npc,st):
     ...
     if npcId==7834 :
         if id == CREATED :
             if st.getPlayer().getClassId().getId() in [ 0x11,0xc,0xd,0xe,0x10,0x11,0x1b,0x1c,0x1e,0x28,0x29,0x2b,0x5e,0x5f,0x60,0x61,0x62,0x67,0x68,0x69,0x6e,0x6f,0x70] and level >=40:

...
p_no_items			= html+sophia+"Dear brother of the Black Lion.  Don’t you think that the place where you should be is not in this village but in the battlefield where the evil spirits are running wild!<br><a action=\"bypass -h Quest 333_BlackLionHunt continue\">Continue with your mission.</a><br><a action=\"bypass -h Quest 333_BlackLionHunt leave\">Stop the mission you have been engaged in.</a>"+htmlend
...
p_both_info			= html+sophia+"Dear brother.  I appreciate your hard work in carrying out the mission.  I’ll give you your reward according to the number of proofs you have brought back.<br>What is that box…?  It seems like you have brought back a cargo box that belongs to a traders union.  Since there is no clause regarding the returning of a cargo box written in our contract,  I guess we don’t have the duty to return the cargo to the traders. But, if we return it to the traders’ union, perhaps they will give us some sort of reward?   If you don’t feel like helping traders, you can go see Red Foot.   He is an expert in dealing with spoils that are hard to get rid of. <br><a action=\"bypass -h Quest 333_BlackLionHunt p_redfoot\">Ask about Red Foot. </a><br><a action=\"bypass -h Quest 333_BlackLionHunt p_trader_info\">Ask about the traders union.</a><br> <a action=\"bypass -h Quest 333_BlackLionHunt continue\">Continue with your mission.</a><br><a action=\"bypass -h Quest 333_BlackLionHunt leave\">Stop the mission you have been engaged in.</a>"+htmlend
p_only_item_info	= html+sophia+"Dear brother.  I appreciate your hard work in carrying out the mission. I’ll give you your reward according to the number of proofs you have brought back.<br><a action=\"bypass -h Quest 333_BlackLionHunt continue\">Continue to carry out the mission.</a><br><a action=\"bypass -h Quest 333_BlackLionHunt leave\">Stop the mission you have been engaged in.</a>"+htmlend
p_leave_mission		= html+sophia+"I appreciate your hard work so far.  Even a lion needs a break.   Retire to the village and replenish your energy while resting there.  Maintaining one’s own physical strength is one of the basic skills of being a mercenary.<br><a action=\"bypass -h Quest 333_BlackLionHunt start_chose_parts\">Tell him that you would like to take on a new mission.</a><br><a action=\"bypass -h Quest 333_BlackLionHunt r_exit\">Leave the mercenary troop.</a>"+htmlend
p_only_box_info		= html+sophia+"Dear brother.  I appreciate your hard work in carrying out the mission.  I’ll give you your reward according to the number of proofs you have brought back.<br><a action=\"bypass -h Quest 333_BlackLionHunt continue\">Continue to carry out the mission.</a><br><a action=\"bypass -h Quest 333_BlackLionHunt leave\">Stop the mission you have been engaged in.</a>"+htmlend
p_first_eye			= html+sophia+"Wait a moment.  I present to you the <font color=\"LEVEL\">mark of the lion’s eye</font>. This is an award to recognize your distinguished services that you have demonstrated on the battlefield.  And new supplies have been issued for you.   Since they are expendable goods that will be useful in combat, store and guard them well!  Now, I expect you to continue to make great achievements."+htmlend
p_eye				= html+sophia+"Wait a moment.  I present to you the <font color=\"LEVEL\">mark of the lion’s eye</font>. This is an award to recognize your distinguished services that you have demonstrated on the battlefield.  And new supplies have been issued for you.   Since they are expendable goods that will be useful in combat, store and guard them well!  Now, I expect you to continue to make great achievements."+htmlend
#-exit messages
r_exit				= html+sophia+"What?!  You want to leave the Black Lion troop?  Well, I guess you must have your own reasons.  I won’t ask about that…  However, I’ll tell you one thing…  The only place for someone like yourself who was born with the blood of a fighter is in a mercenary troop.  No matter where you go, you are destined to end up on the battlefield.<br>Anyhow, if you really want to withdraw from the mercenary troop, bear this in mind.  Upon your departure, you will have to return the Black Lion Mark.  Also, according to your contributions of service you have achieved so far, you will receive the proper discharge pay.<br><a action=\"bypass -h Quest 333_BlackLionHunt continue\">Continue to work for the mercenary troop.</a><br><a action=\"bypass -h Quest 333_BlackLionHunt exit\">Leave the mercenary troop.</a>"+htmlend
...
start_ask_again		= html+sophia+"Dear Black Lion brother, the war with the evil spirits has already started! Don’t you think you should be active in this fight with us?<br><a action=\"bypass -h Quest 333_BlackLionHunt start_parts\">Listen to the explanation about the mission.</a>"+htmlend
start_continue		= html+sophia+"Hurry!  Rush to the battlefield, destroy your enemies and taste the sweetness of victory!"+htmlend
#-Part 1
p1_explanation		= html+sophia+"The Execution Ground is located in the eastern part of the village. It is an eerie place where people can hear the never ending cries of dead souls. Your mission is to clean out the undead that are infesting the place. According to a rumor, in order to pay for the spilled blood of innocent people who were killed during the farmers uprising, the undead came back to this world… Well, all I know is that we need to carry out the given assignment. Still, I don’t feel good about this for some reason. <br><a action=\"bypass -h Quest 333_BlackLionHunt p1_t\">Take on the mission.</a><br><a action=\"bypass -h Quest 333_BlackLionHunt start_chose_parts\">Listen to the explanation about another mission.</a>"+htmlend
p1_take				= html+sophia+"The undead that we need to drive out are <font color=\"LEVEL\">specters, sorrow maiden, neer crawlers, neer ghoul berserker, strains and ghouls</font>. I don’t know whether you know about this or not.  But when an undead is destroyed, it leaves behind a handful of ashes.  Bring me back that as proof of victory.  The more <font color=\"LEVEL\">ashes of undead </font> you bring, the more rewards you will receive.  Since you once worked under Captain Leopold, you already know the rule about proofs and rewards, don’t you?  <br> Now then, hurry up.  Prepare yourself for combat and leave for the Execution Ground immediately. Prove to everybody the fact that even the undead who have been resurrected from the dungeon of purgatory will not be a match for us the Black Lion troop!"+htmlend
#-Part 2
p2_explanation		= html+sophia+"This mission is to drive out the remnants of the Grecian military force that is currently encamped in the northwestern part of  the Horseshoe Valley.  Don’t take them too lightly by thinking that they are mere rabble of defeated soldiers.    Your opponents are ol mahums of the Bloody Axe army led by the Blood Lord Nurka.  They are a formidable enemy that you shouldn’t take too lightly.<br><a action=\"bypass -h Quest 333_BlackLionHunt p2_t\">Take on the mission.<\a> <br> <a action=\"bypass -h Quest 333_BlackLionHunt start_chose_parts\">Listen to the explanation about another mission.</a>"+htmlend
p2_take				= html+sophia+"The enemies that you will have to defeat are <font color=\"LEVEL\">ol mahum guerillas, ol mahum raiders, ol mahum marksman, ol mahum sergeants and ol mahum captains</font>.<br>As a proof that you have defeated the enemy, bring me back the <font color=\"LEVEL\">bloodyaxe insignia</font> the symbol of the partisan army.  The more proofs you bring, the greater your reward will be.  Well, since you once worked under Captain Leopold, you already know the rule about proofs and rewards, don’t you?<br>Now then, hurry up and leave for the Partisan Hideaway. Show them the wrath of the Black Lion troop to those rampaging ol mahums!"+htmlend
#-Part 3
p3_explanation		= html+sophia+"The headquarters of delu lizardmen was originally located at the shore area in the southern part of Giran.  However, lately, many of them are infiltrating into Dion territory.  We don’t know yet whether they are entering Dion just to find food or to prepare some large scale invasion.  But what is clear is that they are making their movements with some clear goal.  Our mission is to smash their units one by one and instill fear in them thereby discouraging them from settling down in this area.<br><a action=\"bypass -h Quest 333_BlackLionHunt p3_t\">Take on the mission.</a> <br> <a action=\"bypass -h Quest 333_BlackLionHunt start_chose_parts\">Listen to the explanation about another mission.</a>"+htmlend
p3_take				= html+sophia+"The enemies that you will deal with are <font color=\"LEVEL\"delu lizardmen, delu lizardman scouts and delu lizardman warriors</font>. As a proof that you slayed them, bring back the <font color=\"LEVEL\"delu lizardmen’s teeth</font>. But be careful.  Comparing with the felim tribe in Gludio or langk lizardman, they are much more violent and hostile.<br>The more proofs of victory you bring, the greater your reward will be.  Well, since you once worked under Captain Leopold, you should already know the rule about proofs and rewards, don’t you? <br>Well then, leave for the battleground.  Trample down and destroy those lizards that are running amok without knowing their proper place!"+htmlend
#-Part 4
p4_explanation		= html+sophia+"This mission has to deal with weird evil creatures called “stacato” that are infesting the Cruma Marshlands.  Have you ever seen a stacato?  It looks like an insect.  It’s a sinister race that gives you a creepy feeling.  Their body is covered by a tight stakato chitin and they have sharp claws instead of hands.  They also have surprisingly fast movements.  You should never underestimate them. <br>To make matters worse, the Marshlands are inhabited by giant leeches, spiders and strange evil spirits hovering around the Tower of Giants.  This makes the place very treacherous when one has to carry out military operations.<br><a action=\"bypass -h Quest 333_BlackLionHunt p4_t\">Take on the mission.</a><br><a action=\"bypass -h Quest 333_BlackLionHunt start_chose_parts\">Listen to the explanation about another mission.</a>"+htmlend
...
f_no_box			= html+redfoot+"Hey brother!  Did you tell me that you’re currently on active duty?  I know that must be hard work!  Is there anything I can help you with?<br><a action=\"bypass -h Quest 333_BlackLionHunt f_info\">Ask whether he has any useful information.</a>"+htmlend
f_give_box			= html+redfoot+"Hey brother!  Did you tell me that you’re currently on active duty?  I know that must be hard work!  Is there anything I can help you with?<br>What kind of box is that…?  Oh, I know.  That’s a cargo box used by traders.  Since you brought it to me…  I can assume that you don’t have any intention of returning it to the merchant, am I right?  All right.  I’ll open the box for you.  Of course, you can have the contents of the box.  Instead, I’ll charge you a small fee.  I think <font color=\"LEVEL\">650 adena</font> will be appropriate.  Think of it as the price for opening the box and for keeping my mouth shut.<br><a action=\"bypass -h Quest 333_BlackLionHunt f_give\">Ask him to open the box for you.</a><br>"+back+htmlend
f_rnd_list			= ["Some time ago, I overheard some dwarves talking among themselves in a blacksmith’s shop…  The head of the dwarves… perhaps he is called the first elder?  Anyway, he was desperately looking for a scroll that had hieroglyphic characters of giants on it.  Although I didn’t get to hear the details, it seemed like some very critical secret regarding the giants’ scientific technology was written on it.  I always thought that dwarves were just busying themselves with their work in blacksmith shops and being warehouse keepers.  But what do you know…  I think they have been working on secret things while avoiding the scrutiny of humans.<br>",
					   "Some time ago, while I was talking with the members of the Dark Elf Guild, I found out that… Dark Elves worship the Goddess Shilen!!   Are you saying that everybody already knows about that?   Well, I heard about it for the first time…  <br>Why would you want to worship a goddess of death…  It doesn’t make any sense to me.  But according to those who have been to the Dark Forest, the Temple of Shilen built by the Dark Elves is truly magnificent.  They told me that the Abyssal Celebrants at the temple are gathering fragments of the statue of Goddess Shilen from everywhere!<br>",
					   "Have you ever heard of a hatchling?  It is a cute baby dragon that has been hatched from the egg of a wyrm or a drake.  Among pet handlers, I heard that there is someone who knows how to raise a hatchling as one’s own pet…  I think his name is Cooper or something like that.  If you are interested in keeping a hatchling as a pet, why don’t you go see him!<br>",
					   "I will give you the information that a clan leader, who wants to grow the power of his clan would be interested in obtaining.  In each area, there are aristocrats who give support to small clans.  These aristocrats would include Sir Kristof Rodemai in Giran Castle Town and Sir Gustaf Athebaldt of Oren Castle Town.  Of course they are not just philanthropists.  I would say they would want something in return for their support of a clan, wouldn’t you agree?<br>",
					   ...
					   "I heard that if you go near the Ivory Tower in Oren, you will find a fake alchemist.  It is said that he goes around telling people that he can make some magic potion that will make people’s wishes come true…  Many people have fallen victim to his fake potion.  But what is surprising is that once in a blue moon, after using the potion people’s wishes actually did come true.  The problem is that this only happens ‘very very rarely’…<br>",
					   "Hush!  Come closer to me.  I’ll give you some information of great worth.  I overheard traders talking among themselves.  Some time ago, the cargo wagon of the Aden Business Association that was traveling from Giran to Dion had been robbed and an item of great value was stolen.  It is a gem called the Imperial Diamond and it is a priceless gem.  Well, since it was a gemstone that used to decorate a king’s crown, it wouldn’t be an ordinary item… now would it?  I wish I could have the opportunity to look at it even once in my life time…<br>",
					   ...
					   "In Giran Castle Town, there is a young man whose only aim in life is to take revenge.  Everybody has been telling him that it’s useless but he is determined to kill the earthdragon Antharas with his own hands.  Every day, he makes special arrows.  Furthermore, if anybody brings him the raw materials he needs to make the arrows, he will pay the person with an ample reward.  If you are interested, why don’t you go see him?  His name is  Belton and he works as a guard in Giran Castle Town.<br>",
					   "I will give you some information that will be useful to someone who travels a lot like yourself.  According to the law of the land, the traders of this kingdom are not allowed to deal with criminals.  But there are some traders who ignore this rule and sell their items to outlaws.  These people include, Grocer Pano of Floran Village and Twyla who has set up her trade in the western section of the Dark Forest.  Although they are business people, I think it’s shameless of them to deal with criminals… just to make money.<br>",
...
f_no_news			= html+redfoot+"Sorry.  I don’t have any new information for you.  Why don’t you stop by again later.<br>"+back+htmlend
...
f_no_more_box		= html+redfoot+"I don’t know what to say to you!  You don’t even have a Cargo Box with you.  But are you still asking me to open one?<br><br><a action=\"bypass -h Quest 333_BlackLionHunt f_info\">Ask whether he has any useful information.</a>"+htmlend
...
f_not_adena			= html+redfoot+"Listen here brother…!  This is not enough money!!!  You didn’t think by any chance that I would give out the information to you for free, did you?  This is business for me too, understand!<br>"+back+htmlend
#Rupio
...
u_info				= html+undiras+"That statue is a sacred object for us dark elves.  Anyway, if you keep it for yourself, you won’t have much use for it.  Furthermore, if you carry a statue of Shilen with you and walk around among humans, people will accuse you of being a pagan.  You would be lucky if you are not burnt to death at the stake.  Anyway, if you change your mind, please come back and see me.  If you hand over the statue to me, I am willing to pay you a generous sum of reward money.  Well,  then may the divine protection of abyss be with you."+htmlend
#Morgan
			...
			if st.getQuestItemsCount(CARGO_BOX1) :
				if st.getQuestItemsCount(ADENA_ID)>=OPEN_BOX_PRICE:
					...
					if random < 21 :
						...
						return html+redfoot+standart+"Isn’t this corn meal?  Isn’t this used to feed pigs?  Well, anyhow, since it’s not anything you can use for yourself, you should take it to the market to sell it.<br>"+back+htmlend
					elif random < 61:
						st.giveItems(WOLF_PELTS,1)
						return html+redfoot+standart+"<br>What’s this… pelts…?  Dire Wolf Pelts?  They seem to have been tanned by a leather craftman. But they are not of high quality.  Maybe they can be used to make leather hats?  Well, anyhow, if you take them to the market, you will get some money for them.<br>"+back+htmlend
					elif random < 74:
						...
						return html+redfoot+standart+"<br>Hmm?  What’s this powder…?  Should I taste it?   Yes, this must be Gludio Wheat Flour!  It can be used for baking bread I guess.   Well, anyhow, you should be able to sell it for a decent price at the market.<br>"+back+htmlend
					elif random < 98:
						st.giveItems(SPIDERSILK_ROPE,1)
						return html+redfoot+standart+"What’s this…?  It’s Spidersilk Rope!  It’s a very strong and light rope that is made from the spidersilk that is collected from the Tarantula Spider’s webs in the Spine Mountain Range.  If you take it to a store, I’m sure you should be able to get a really good price for it.<br>"+back+htmlend
					elif random < 99:
						...
						return html+redfoot+standart+"Hmm?  Machine parts…?  This Guild Mark seems to be that of the Black Anvil Guild… what do you think?  Although I don’t know for sure, these seem to be parts that are used by dwarves to do repair work on golems.  If you take them to a store, I think you will be able to sell them at a pretty reasonable price.<br>"+back+htmlend
					elif random < 123:
						st.giveItems(FIRE_EMERALD,1)
						return html+redfoot+standart+"What’s this gem…?  Ah!  It’s a Fire Emerald!  Don’t you know about it?  it’s a rare and precious gemstone that gives out a strong red light when it’s exposed to sun light.  You are so lucky!  You can take it to a store and sell it at a very high price.<br>"+back+htmlend
					elif random < 127:
						st.giveItems(SILK_FROCK,1)
						return html+redfoot+standart+"Isn’t this a dress?!  This is a silk dress for a woman.  It looks pretty expensive, don’t you think?  Take a look at this design.  This is an item that has been imported from Avella of the East.  At a time like this, who would use such a luxurious item…?  This must be ordered by a noblewoman who has a liking for foreign products… don’t you think?  You should take this to a store and sell it off!  I’m sure you will get a very high price for it.<br>"+back+htmlend
					elif random < 131:
						st.giveItems(PORCELAN_URN,1)
						return html+redfoot+standart+back+htmlend
					elif random < 132:
						st.giveItems(IMPERIAL_DIAMOND,1)
						return html+redfoot+standart+"Hmm?  Don’t tell me!  I don’t believe it!!!  Wow, an Imperial… Diamond?  Isn’t this the one that was used to decorate the crown of the king of Elmo-Aden…?  It’s truly… beautiful…!   You are extremely lucky!  You got yourself a priceless item.  If you take it to the market, I’m sure you will be able to get a huge amount of money for it.<br>"+back+htmlend
					elif random < 147:

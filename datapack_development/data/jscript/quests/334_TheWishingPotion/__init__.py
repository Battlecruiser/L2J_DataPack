...
#### WISH I : Please make me into a loving person.
     ...
     if st.getQuestItemsCount(WISH_POTION) :
       st.set("wish","1")
       st.startQuestTimer("matild_timer1",3000,npc,player)
...
#### WISH IV : I'd like to become the wisest person in the world.
     ...
     st.startQuestTimer("matild_timer2",4000,npc,player)
     return
   elif event == "matild_timer2":
     autochat(npc,"Both hands to heaven, everybody yell together!")
     st.startQuestTimer("matild_timer3",4000,npc,player)
     return
     ...
     if wish == 1 :
       ...
       if WISH_CHANCE <= 33 :
         ...
         st.startQuestTimer("sanches_timer1",200000,spawnedNpc,player)
     elif wish == 4 :
       if WISH_CHANCE <= 33:
     ...
     if npcId == SUCCUBUS_OF_SEDUCTION:
       ...
       try :
         ...
         if st.getRandom(100) <= 50 :
            ...
            st.startQuestTimer("bonaparterius_timer1",600000,spawnedNpc,player)
         else :
            st.giveItems(R4[st.getRandom(len(R4))],1)
       except : pass
       ...
       try :
         ...
         if st.getRandom(100) <= 50 :
           ...
           st.startQuestTimer("ramsebalius_timer1",600000,spawnedNpc,player)
         else :
           st.giveItems(R4[st.getRandom(len(R4))],1)
       except : pass
       ...
       try :
         ...
         if st.getRandom(100) <= 50 :
           ...
           st.startQuestTimer("greatdemon_timer1",600000,spawnedNpc,player)
         else :
           st.giveItems(R4[st.getRandom(len(R4))],1)
       except: pass

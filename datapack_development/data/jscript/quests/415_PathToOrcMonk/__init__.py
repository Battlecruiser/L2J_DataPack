...
class Quest (JQuest) :
 ...
 def onTalk (Self,npcId,st):
   ...
   if npcId == 7587 and int(st.get("cond"))==0 :
        if int(st.get("cond"))<15 :
          ...
          htmltext = "7587-01.htm"
   elif npcId == 7587 and int(st.get("cond"))==1 and st.getQuestItemsCount(SCROLL_FIERY_SPIRIT_ID)==0 and st.getQuestItemsCount(POMEGRANATE_ID)==1 and st.getQuestItemsCount(GANTAKIS_LETTER_ID)==0 and st.getQuestItemsCount(ROSHEEKS_LETTER_ID)==0 and ((st.getQuestItemsCount(LEATHER_POUCH1_ID)+st.getQuestItemsCount(LEATHER_POUCH2_ID)+st.getQuestItemsCount(LEATHER_POUCH3_ID)+st.getQuestItemsCount(LEATHER_POUCH1FULL_ID)+st.getQuestItemsCount(LEATHER_POUCH2FULL_ID)+st.getQuestItemsCount(LEATHER_POUCH3FULL_ID))==0) :
        htmltext = "7587-07.htm"
   elif npcId == 7587 and int(st.get("cond"))==1 and st.getQuestItemsCount(SCROLL_FIERY_SPIRIT_ID)==0 and st.getQuestItemsCount(POMEGRANATE_ID)==0 and st.getQuestItemsCount(GANTAKIS_LETTER_ID)==0 and st.getQuestItemsCount(ROSHEEKS_LETTER_ID)==0 and ((st.getQuestItemsCount(LEATHER_POUCH1_ID)+st.getQuestItemsCount(LEATHER_POUCH2_ID)+st.getQuestItemsCount(LEATHER_POUCH3_ID)+st.getQuestItemsCount(LEATHER_POUCH1FULL_ID)+st.getQuestItemsCount(LEATHER_POUCH2FULL_ID)+st.getQuestItemsCount(LEATHER_POUCH3FULL_ID))==1) :
        htmltext = "7587-08.htm"
   elif npcId == 7587 and int(st.get("cond"))==1 and st.getQuestItemsCount(SCROLL_FIERY_SPIRIT_ID)==1 and st.getQuestItemsCount(POMEGRANATE_ID)==0 and st.getQuestItemsCount(GANTAKIS_LETTER_ID)==0 and st.getQuestItemsCount(ROSHEEKS_LETTER_ID)==1 and ((st.getQuestItemsCount(LEATHER_POUCH1_ID)+st.getQuestItemsCount(LEATHER_POUCH2_ID)+st.getQuestItemsCount(LEATHER_POUCH3_ID)+st.getQuestItemsCount(LEATHER_POUCH1FULL_ID)+st.getQuestItemsCount(LEATHER_POUCH2FULL_ID)+st.getQuestItemsCount(LEATHER_POUCH3FULL_ID))==0) :
        htmltext = "7587-09.htm"
        st.takeItems(ROSHEEKS_LETTER_ID,1)
        st.giveItems(GANTAKIS_LETTER_ID,1)
   elif npcId == 7587 and int(st.get("cond"))==1 and st.getQuestItemsCount(SCROLL_FIERY_SPIRIT_ID)==1 and st.getQuestItemsCount(POMEGRANATE_ID)==0 and st.getQuestItemsCount(GANTAKIS_LETTER_ID)==1 and st.getQuestItemsCount(ROSHEEKS_LETTER_ID)==0 and ((st.getQuestItemsCount(LEATHER_POUCH1_ID)+st.getQuestItemsCount(LEATHER_POUCH2_ID)+st.getQuestItemsCount(LEATHER_POUCH3_ID)+st.getQuestItemsCount(LEATHER_POUCH1FULL_ID)+st.getQuestItemsCount(LEATHER_POUCH2FULL_ID)+st.getQuestItemsCount(LEATHER_POUCH3FULL_ID))==0) :
        htmltext = "7587-10.htm"
   elif npcId == 7587 and int(st.get("cond"))==1 and st.getQuestItemsCount(SCROLL_FIERY_SPIRIT_ID)==1 and st.getQuestItemsCount(POMEGRANATE_ID)==0 and st.getQuestItemsCount(GANTAKIS_LETTER_ID)==0 and st.getQuestItemsCount(ROSHEEKS_LETTER_ID)==0 and ((st.getQuestItemsCount(LEATHER_POUCH1_ID)+st.getQuestItemsCount(LEATHER_POUCH2_ID)+st.getQuestItemsCount(LEATHER_POUCH3_ID)+st.getQuestItemsCount(LEATHER_POUCH1FULL_ID)+st.getQuestItemsCount(LEATHER_POUCH2FULL_ID)+st.getQuestItemsCount(LEATHER_POUCH3FULL_ID))==0) :
 ...
 def onKill (self,npcId,st):
   if npcId == 479 :
        st.set("id","0")
        if int(st.get("cond")) == 1 and st.getQuestItemsCount(LEATHER_POUCH1_ID) == 1 :
        ...
        st.set("id","0")
        if int(st.get("cond")) == 1 and st.getQuestItemsCount(LEATHER_POUCH3_ID) == 1 :
        ...
        st.set("id","0")
        if int(st.get("cond")) == 1 and st.getQuestItemsCount(LEATHER_POUCH2_ID) == 1 :
        ...
        st.set("id","0")
        if int(st.get("cond")) == 1 and st.getQuestItemsCount(LEATHER_PURSE4_ID) == 1 and st.getQuestItemsCount(VUKU_TUSK_ID)<3 :
        ...
        st.set("id","0")
        if int(st.get("cond")) == 1 and st.getQuestItemsCount(LEATHER_PURSE4_ID) == 1 and st.getQuestItemsCount(RATMAN_FANG_ID)<3 :
          if st.getQuestItemsCount(RATMAN_FANG_ID)+st.getQuestItemsCount(LANGK_TOOTH_ID)+st.getQuestItemsCount(FELIM_TOOTH_ID)+st.getQuestItemsCount(VUKU_TUSK_ID) >= 11 :
            st.takeItems(VUKU_TUSK_ID,st.getQuestItemsCount(VUKU_TUSK_ID))
            st.takeItems(RATMAN_FANG_ID,st.getQuestItemsCount(RATMAN_FANG_ID))
            st.takeItems(LANGK_TOOTH_ID,st.getQuestItemsCount(LANGK_TOOTH_ID))
        ...
        st.set("id","0")
        if int(st.get("cond")) == 1 and st.getQuestItemsCount(LEATHER_PURSE4_ID) == 1 and st.getQuestItemsCount(LANGK_TOOTH_ID)<3 :
          if st.getQuestItemsCount(RATMAN_FANG_ID)+st.getQuestItemsCount(LANGK_TOOTH_ID)+st.getQuestItemsCount(FELIM_TOOTH_ID)+st.getQuestItemsCount(VUKU_TUSK_ID) >= 11 :
            st.takeItems(VUKU_TUSK_ID,st.getQuestItemsCount(VUKU_TUSK_ID))
            st.takeItems(RATMAN_FANG_ID,st.getQuestItemsCount(RATMAN_FANG_ID))
            st.takeItems(LANGK_TOOTH_ID,st.getQuestItemsCount(LANGK_TOOTH_ID))
        ...
        st.set("id","0")
        if int(st.get("cond")) == 1 and st.getQuestItemsCount(LEATHER_PURSE4_ID) == 1 and st.getQuestItemsCount(FELIM_TOOTH_ID)<3 :
          if st.getQuestItemsCount(RATMAN_FANG_ID)+st.getQuestItemsCount(LANGK_TOOTH_ID)+st.getQuestItemsCount(FELIM_TOOTH_ID)+st.getQuestItemsCount(VUKU_TUSK_ID) >= 11 :
            st.takeItems(VUKU_TUSK_ID,st.getQuestItemsCount(VUKU_TUSK_ID))
            st.takeItems(RATMAN_FANG_ID,st.getQuestItemsCount(RATMAN_FANG_ID))
            st.takeItems(LANGK_TOOTH_ID,st.getQuestItemsCount(LANGK_TOOTH_ID))

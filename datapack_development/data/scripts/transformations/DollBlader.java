...
public class DollBlader extends L2Transformation
{
	...
	public void removeSkills()
	{
		...
		{
			getPlayer().removeSkill(SkillTable.getInstance().getInfo(752, 2), false, false);
			getPlayer().removeSkill(SkillTable.getInstance().getInfo(753, 2), false, false);
		}
		else
		{
			getPlayer().removeSkill(SkillTable.getInstance().getInfo(752, 1), false, false);
			getPlayer().removeSkill(SkillTable.getInstance().getInfo(753, 1), false, false);
		}

...
public class Ranku extends L2Transformation
{
	...
	public void transformedSkills()
	{
		...
		getPlayer().setTransformAllowedSkills(new int[]{619,5491,731,732});
	}
	...
	public void removeSkills()
	{
		...
		getPlayer().removeSkill(SkillTable.getInstance().getInfo(731, 1), false, false);
		getPlayer().removeSkill(SkillTable.getInstance().getInfo(732, 1), false, false);

...
public class Zaken extends L2Transformation
{
	...
	public void removeSkills()
	{
		...
		getPlayer().removeSkill(SkillTable.getInstance().getInfo(715, 1), false, false);
		getPlayer().removeSkill(SkillTable.getInstance().getInfo(716, 1), false, false);
		getPlayer().removeSkill(SkillTable.getInstance().getInfo(717, 1), false, false);
		getPlayer().removeSkill(SkillTable.getInstance().getInfo(718, 1), false, false);

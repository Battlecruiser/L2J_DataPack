...
public class GolemGuardianNormal extends L2Transformation
{
	...
	{
		// Double Slasher
		getPlayer().removeSkill(SkillTable.getInstance().getInfo(572, 3), false, false);
		// Earthquake
		getPlayer().removeSkill(SkillTable.getInstance().getInfo(573, 3), false, false);
		// Bomb Installation
		getPlayer().removeSkill(SkillTable.getInstance().getInfo(574, 3), false, false);
		// Steel Cutter
		getPlayer().removeSkill(SkillTable.getInstance().getInfo(575, 3), false, false);
		// Transfrom Dispel

...
public class GolemGuardianWeak extends L2Transformation
{
	...
	{
		// Double Slasher
		getPlayer().removeSkill(SkillTable.getInstance().getInfo(572, 2), false, false);
		// Earthquake
		getPlayer().removeSkill(SkillTable.getInstance().getInfo(573, 2), false, false);
		// Bomb Installation
		getPlayer().removeSkill(SkillTable.getInstance().getInfo(574, 2), false, false);
		// Steel Cutter
		getPlayer().removeSkill(SkillTable.getInstance().getInfo(575, 2), false, false);
		// Transfrom Dispel

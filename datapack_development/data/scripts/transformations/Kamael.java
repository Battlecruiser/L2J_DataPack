...
public class Kamael extends L2Transformation
{
    ...
    {
        // Nail Attack
        getPlayer().removeSkill(SkillTable.getInstance().getInfo(539, 1), false, false);
        // Wing Assault
        getPlayer().removeSkill(SkillTable.getInstance().getInfo(540, 1), false, false);
        // Soul Sucking
        getPlayer().removeSkill(SkillTable.getInstance().getInfo(1471, 1), false, false);
        // Death Beam
        getPlayer().removeSkill(SkillTable.getInstance().getInfo(1472, 1), false, false);
        // Transfrom Dispel

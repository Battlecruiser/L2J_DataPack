...
public class Heretic extends L2Transformation
{
	...
	public void removeSkills()
	{
		...
		if (getPlayer().getLevel() >= 76)
		{
			getPlayer().removeSkill(SkillTable.getInstance().getInfo(738, 3), false, false);
			getPlayer().removeSkill(SkillTable.getInstance().getInfo(739, 3), false, false);
			getPlayer().removeSkill(SkillTable.getInstance().getInfo(740, 3), false, false);
			getPlayer().removeSkill(SkillTable.getInstance().getInfo(741, 3), false, false);
		}
		else if (getPlayer().getLevel() >= 73)
		{
			getPlayer().removeSkill(SkillTable.getInstance().getInfo(738, 2), false, false);
			getPlayer().removeSkill(SkillTable.getInstance().getInfo(739, 2), false, false);
			getPlayer().removeSkill(SkillTable.getInstance().getInfo(740, 2), false, false);
			getPlayer().removeSkill(SkillTable.getInstance().getInfo(741, 2), false, false);
		}
		else
		{
			getPlayer().removeSkill(SkillTable.getInstance().getInfo(738, 1), false, false);
			getPlayer().removeSkill(SkillTable.getInstance().getInfo(739, 1), false, false);
			getPlayer().removeSkill(SkillTable.getInstance().getInfo(740, 1), false, false);

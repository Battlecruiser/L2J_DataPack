...
public class LilimKnightNormal extends L2Transformation
{
	...
	{
		// Attack Buster
		getPlayer().removeSkill(SkillTable.getInstance().getInfo(568, 3), false, false);
		// Attack Storm
		getPlayer().removeSkill(SkillTable.getInstance().getInfo(569, 3), false, false);
		// Attack Rage
		getPlayer().removeSkill(SkillTable.getInstance().getInfo(570, 3), false, false);
		// Poison Dust
		getPlayer().removeSkill(SkillTable.getInstance().getInfo(571, 3), false, false);
		// Transfrom Dispel

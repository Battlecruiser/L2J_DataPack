...
public class InfernoDrakeWeak extends L2Transformation
{
	...
	{
        // Paw Strike
		getPlayer().removeSkill(SkillTable.getInstance().getInfo(576, 2), false, false);
		// Fire Breath
		getPlayer().removeSkill(SkillTable.getInstance().getInfo(577, 2), false, false);
		// Blaze Quake
		getPlayer().removeSkill(SkillTable.getInstance().getInfo(578, 2), false, false);
		// Fire Armor

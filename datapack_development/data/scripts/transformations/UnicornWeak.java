...
public class UnicornWeak extends L2Transformation
{
	...
	{
		// Horn of Doom
		getPlayer().removeSkill(SkillTable.getInstance().getInfo(563, 2), false, false);
		// Gravity Control
		getPlayer().removeSkill(SkillTable.getInstance().getInfo(564, 2), false, false);
		// Horn Assault
		getPlayer().removeSkill(SkillTable.getInstance().getInfo(565, 2), false, false);
		// Light of Heal
		getPlayer().removeSkill(SkillTable.getInstance().getInfo(567, 2), false, false);
		// Transfrom Dispel

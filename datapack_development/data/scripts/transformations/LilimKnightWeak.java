...
public class LilimKnightWeak extends L2Transformation
{
	...
	{
		// Attack Buster
		getPlayer().removeSkill(SkillTable.getInstance().getInfo(568, 2), false, false);
		// Attack Storm
		getPlayer().removeSkill(SkillTable.getInstance().getInfo(569, 2), false, false);
		// Attack Rage
		getPlayer().removeSkill(SkillTable.getInstance().getInfo(570, 2), false, false);
		// Poison Dust
		getPlayer().removeSkill(SkillTable.getInstance().getInfo(571, 2), false, false);
		// Transfrom Dispel

...
public class InfernoDrakeStrong extends L2Transformation
{
	...
	{
        // Paw Strike
		getPlayer().removeSkill(SkillTable.getInstance().getInfo(576, 4), false, false);
		// Fire Breath
		getPlayer().removeSkill(SkillTable.getInstance().getInfo(577, 4), false, false);
		// Blaze Quake
		getPlayer().removeSkill(SkillTable.getInstance().getInfo(578, 4), false, false);
		// Fire Armor

...
public class UnicornStrong extends L2Transformation
{
	...
	{
		// Horn of Doom
		getPlayer().removeSkill(SkillTable.getInstance().getInfo(563, 4), false, false);
		// Gravity Control
		getPlayer().removeSkill(SkillTable.getInstance().getInfo(564, 4), false, false);
		// Horn Assault
		getPlayer().removeSkill(SkillTable.getInstance().getInfo(565, 4), false, false);
		// Light of Heal
		getPlayer().removeSkill(SkillTable.getInstance().getInfo(567, 4), false, false);
		// Transfrom Dispel

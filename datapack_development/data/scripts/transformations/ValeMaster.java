...
public class ValeMaster extends L2Transformation
{
	...
	public void removeSkills()
	{
		...
		if (getPlayer().getLevel() >= 76)
		{
			...
			getPlayer().removeSkill(SkillTable.getInstance().getInfo(745, 3), false, false);
		}
		else if (getPlayer().getLevel() >= 73)
		{
			getPlayer().removeSkill(SkillTable.getInstance().getInfo(742, 2), false, false);
			getPlayer().removeSkill(SkillTable.getInstance().getInfo(743, 2), false, false);
			getPlayer().removeSkill(SkillTable.getInstance().getInfo(744, 2), false, false);
			getPlayer().removeSkill(SkillTable.getInstance().getInfo(745, 2), false, false);
		}
		else
		{
			getPlayer().removeSkill(SkillTable.getInstance().getInfo(742, 1), false, false);
			getPlayer().removeSkill(SkillTable.getInstance().getInfo(743, 1), false, false);
			getPlayer().removeSkill(SkillTable.getInstance().getInfo(744, 1), false, false);
			getPlayer().removeSkill(SkillTable.getInstance().getInfo(745, 1), false, false);
		}

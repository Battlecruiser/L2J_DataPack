...
public class MC_Show extends AbstractNpcAI
{
	...
	private static NpcStringId[] MESSAGES =
	{
		...
		NpcStringId.NOW_ID_LIKE_TO_INTRODUCE_THE_MOST_BEAUTIFUL_SINGER_IN_ADEN_PLEASE_WELCOME_LEYLA_MIRA,
		...
		NpcStringId.LETS_WELCOME_OUR_FIRST_VOLUNTEER,
		NpcStringId.AH,
		NpcStringId.MOVING_ON_LETS_WELCOME_OUR_NEXT_VOLUNTEER,
		NpcStringId.IM_SURE_THEY_HAVE_SOMETHING_MUCH_MORE_EXCITING,
		NpcStringId.REALLY,
		NpcStringId.THAT_WAS_JUST_SUPER_AND_NOW_FOR_OUR_LAST_VOLUNTEER,
		NpcStringId.SIGH_AND_THATS_OUR_SHOW_FOLKS,
